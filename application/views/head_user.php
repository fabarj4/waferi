   ...
   <body>
      <nav id="nav">
         ...
         <ul id="slide-out" class="sidenav sidenav-fixed">
            ...
            <li class="headerText">
               <center>Harus nya nama user</center>
            </li>
            </li>
            <div class="headerContent scroll">
               <li id="dashboard" class=""><a href="<?php echo base_url() ?>Panel_User">Dashboard</a></li>
               <li id="penjualan" class=""><a href="<?php echo base_url() ?>penjualan">Penjualan</a></li>
